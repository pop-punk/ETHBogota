        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              ...
              <button className="absolute top-full flex items-center transform -translate-y-1/2 bg-gray-300 rounded-full font-medium group p-4 shadow-lg" onClick={(e) => { e.preventDefault(); e.stopPropagation(); setVideoModalOpen(true); }} aria-controls="modal">
